    ...
    <div className="flex flex-col items-center gap-y-20 py-20 bg-background text-black">
      <AboutCard image="/sobrenos/Colagem.png" title="Nossa História">
        <p>
          ...
          churrasco. Com uma paixão que atravessa gerações, combinamos tradição,
          sabor e qualidade em cada detalhe do nosso serviço. Trabalhamos com
          carnes selecionadas e preparamos tudo com o cuidado e a expertise que
          só uma família apaixonada pelo que faz pode oferecer.
        </p>
        ...
        <p>
          ...
          atendimento acolhedor e sabor inconfundível. Ao longo de mais de duas
          décadas, conquistamos a confiança dos nossos clientes, mantendo viva a
          tradição de um bom churrasco, feito com dedicação e respeito às
          origens.
        </p>
      ...
      <AboutCard image="/sobrenos/Colagem2.png" title="Nossos Serviços">
        ...
        <p>
          Para almoços especiais ou comemorações, levamos até você a tradição do
          churrasco feito com cuidado e carinho. Tudo preparado para que você
          possa curtir cada momento sem preocupações, criando memórias
