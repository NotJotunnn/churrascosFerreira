...
const MenuCard = ({ text = "Loading", link = "/", image }: MenuCardType) => {
  return (
    <div className="w-[315px] h-[220px] text-white rounded-[10px] flex justify-center items-center relative overflow-hidden group">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-accent2opaque from-30% to-transparent to-90% lg:translate-y-60 lg:group-hover:translate-y-0 transition-transform duration-1000 delay-300"></div>
    </div>
  );
};
